...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 25 14:58:06 2019
...
class Net(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_classes,hidden_size2,\
                 hidden_size3,hidden_size4,hidden_size5,hidden_size6):
        ...
        # second full-connected layer: 100  [Hid Node] -> 
        self.fc2 = nn.Linear(hidden_size, hidden_size2)
                    
        # Third full-connected layer  [Hid Node] -> [Hid Node]
        ...
        # Last full-connected layer: 100  [Hid Node] -> 2 [Binary Outp]
        self.fc7 = nn.Linear(hidden_size6, num_classes) 
...
test_loader = torch.utils.data.DataLoader(dataset=test_dataset,
                                          ...
                                          shuffle=False);
# init NN
net = Net(input_size, hidden_size, num_classes,hidden_size2,hidden_size3,\
